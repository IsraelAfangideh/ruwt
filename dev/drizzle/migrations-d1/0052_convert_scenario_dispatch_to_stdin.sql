...
WHERE slug = 'devops-env-resolver';
...
WHERE slug = 'recursive-tree-traversal';
...
WHERE slug = 'translate-and-extend';
...
WHERE slug = 'data-sql-aggregator';
...
WHERE slug = 'py-dependency-resolver';
