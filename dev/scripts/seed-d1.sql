...
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('string-formatter', 'String Formatter', 'Write a function that takes a string and returns it formatted as title case (first letter of each word capitalized, rest lowercase).
...
module.exports = { toTitleCase };', '[{"input":"hello world","expectedOutput":"Hello World"},{"input":"  javaScript  is  FUN  ","expectedOutput":"Javascript Is Fun"},{"input":"","expectedOutput":""},{"input":"a","expectedOutput":"A"},{"input":"ALREADY SHOUTING","expectedOutput":"Already Shouting"}]', NULL, 5000, 256, NULL, 100, 900, 'model_selection', 'Choosing appropriate model tier for simple tasks', NULL, 0, NULL, 'core', 2);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('regex-pattern-matcher', 'Regex Pattern Matcher', 'Implement a function that checks if a string matches a simplified regex pattern.
...
module.exports = { match };', '[{"input":"hello\nhello","expectedOutput":"true"},{"input":"hello\nh.llo","expectedOutput":"true"},{"input":"aaa\na*","expectedOutput":"true"},{"input":"aab\na+b","expectedOutput":"true"},{"input":"\na*","expectedOutput":"true"},{"input":"abc\na+","expectedOutput":"false"},{"input":"mississippi\nmis*is*ip*.","expectedOutput":"true"}]', NULL, 5000, 256, NULL, 2000, 1200, 'model_selection', 'Balancing cost vs capability for medium complexity', NULL, 0, NULL, 'core', 0);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('data-pipeline-transformer', 'Data Pipeline Transformer', 'Build a data pipeline function that takes an array of transformation rules and applies them to input data.
...
module.exports = { encode, decode, analytics };', '[{"input":"encode\nhttps://example.com/test","expectedOutput":"string:6"},{"input":"roundtrip\nhttps://example.com/very/long/path/here","expectedOutput":"https://example.com/very/long/path/here"},{"input":"analytics\nhttps://example.com/clicks","expectedOutput":"{\"clicks\":1}"},{"input":"consistent\nhttps://example.com/same","expectedOutput":"true"}]', NULL, 5000, 256, NULL, NULL, 1800, 'model_selection', 'Strategic use of multiple model tiers', NULL, 0, NULL, 'core', 0);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('one-shot-csv-parser', 'One-Shot CSV Parser', 'Write a CSV parser that converts CSV text to an array of objects.
...
}', '[{"input":"name,age,city\nAlice,30,New York\nBob,25,London","expectedOutput":"[{\"name\":\"Alice\",\"age\":\"30\",\"city\":\"New York\"},{\"name\":\"Bob\",\"age\":\"25\",\"city\":\"London\"}]"},{"input":"a,b\n\"hello, world\",test\n\"say \"\"hi\"\"\",val","expectedOutput":"[{\"a\":\"hello, world\",\"b\":\"test\"},{\"a\":\"say \\\"hi\\\"\",\"b\":\"val\"}]"},{"input":"x\n1\n2\n3","expectedOutput":"[{\"x\":\"1\"},{\"x\":\"2\"},{\"x\":\"3\"}]"}]', '[{"input":"id,val\n1,hello\n2,world","expectedOutput":"[{\"id\":\"1\",\"val\":\"hello\"},{\"id\":\"2\",\"val\":\"world\"}]"},{"input":"name\nAlice\nBob\nCharlie","expectedOutput":"[{\"name\":\"Alice\"},{\"name\":\"Bob\"},{\"name\":\"Charlie\"}]"},{"input":"a,b,c\n1,2,3","expectedOutput":"[{\"a\":\"1\",\"b\":\"2\",\"c\":\"3\"}]"}]', 5000, 256, NULL, 100, 1800, 'prompt_efficiency', 'Concise problem description', 'let _input = '''';
process.stdin.on(''data'', d => _input += d);
process.stdin.on(''end'', () => {
  console.log(JSON.stringify(parseCSV(_input.trim())));
});', 1, '["javascript","csv","parsing"]', 'core', 20);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('algorithmic-sort', 'Algorithmic Sort', 'Implement merge sort that sorts an array of numbers in ascending order.
...
module.exports = { mergeSort };', '[{"input":"[38,27,43,3,9,82,10]","expectedOutput":"[3,9,10,27,38,43,82]"},{"input":"[]","expectedOutput":"[]"},{"input":"[1]","expectedOutput":"[1]"},{"input":"[5,5,3,3,1,1]","expectedOutput":"[1,1,3,3,5,5]"},{"input":"[1,2,3,4,5]","expectedOutput":"[1,2,3,4,5]"}]', NULL, 5000, 256, NULL, NULL, 900, 'prompt_efficiency', 'Minimal prompting for well-known algorithms', NULL, 0, NULL, 'core', 0);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('api-client-generator', 'API Client Generator', 'Write a function that generates a simple API client from a specification object.
...
module.exports = { binarySearch };', '[{"input":"[1,3,5,7,9,11]\n7","expectedOutput":"3"},{"input":"[1,3,5,7,9,11]\n1","expectedOutput":"0"},{"input":"[1,3,5,7,9,11]\n11","expectedOutput":"5"},{"input":"[1,3,5,7,9,11]\n4","expectedOutput":"-1"},{"input":"[]\n5","expectedOutput":"-1"}]', NULL, 5000, 256, NULL, 500, 900, 'iterative_debugging', 'Targeted bug description for efficient fixes', NULL, 0, NULL, 'onboarding', 3);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('refactor-legacy-function', 'Refactor Legacy Function', 'The following function calculates statistics for a dataset but is poorly structured and fails some new test cases.
...
module.exports = { calcStats };', '[{"input":"[1,2,3,4,5]","expectedOutput":"{\"mean\":3,\"median\":3,\"mode\":1,\"stddev\":1.41,\"range\":4,\"outliers\":[]}"},{"input":"[1,2,2,3,4]","expectedOutput":"{\"mean\":2.4,\"median\":2,\"mode\":2,\"stddev\":1,\"range\":3,\"outliers\":[]}"},{"input":"[1,1,2,2,3,3]","expectedOutput":"{\"mean\":2,\"median\":2,\"mode\":1,\"stddev\":0.82,\"range\":2,\"outliers\":[]}"},{"input":"[10,10,10,10,50]","expectedOutput":"{\"mean\":18,\"median\":10,\"mode\":10,\"stddev\":16,\"range\":40,\"outliers\":[50]}"}]', NULL, 5000, 256, NULL, 3000, 1500, 'iterative_debugging', 'Incremental AI-assisted refactoring', NULL, 0, NULL, 'core', 33);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('fix-failing-tests', 'Fix the Failing Tests', 'The following event emitter implementation passes 7 out of 10 test cases but fails 3.
...
module.exports = { EventEmitter };', '[{"input":"basic-on-emit","expectedOutput":"hello"},{"input":"multiple-listeners","expectedOutput":"a,b"},{"input":"emit-with-args","expectedOutput":"1,2,3"},{"input":"off-removes-listener","expectedOutput":"1"},{"input":"off-removes-only-first","expectedOutput":"2"},{"input":"once-fires-once","expectedOutput":"1"},{"input":"once-removable","expectedOutput":"0"},{"input":"emit-returns-boolean","expectedOutput":"true,false"},{"input":"chaining","expectedOutput":"true"},{"input":"listener-count","expectedOutput":"2,1,0"}]', NULL, 5000, 256, NULL, 5000, 2400, 'iterative_debugging', 'Surgical debugging with cost awareness', NULL, 0, NULL, 'core', 0);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('fizzbuzz-budget', 'FizzBuzz Budget', 'Write a function that takes a number and returns:
...
module.exports = { fizzBuzz };', '[{"input":"15","expectedOutput":"FizzBuzz"},{"input":"3","expectedOutput":"Fizz"},{"input":"5","expectedOutput":"Buzz"},{"input":"7","expectedOutput":"7"},{"input":"30","expectedOutput":"FizzBuzz"}]', NULL, 5000, 256, NULL, 50, 900, 'model_selection', 'Using cheapest model for trivial tasks', NULL, 0, NULL, 'onboarding', 1);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('json-transformer', 'JSON Transformer', 'Write a function that flattens a nested JSON object into a single-level object with dot-notation keys.
...
module.exports = { flattenJSON };', '[{"input":"{\"a\":{\"b\":1}}","expectedOutput":"{\"a.b\":1}"},{"input":"{\"a\":[1,2,3]}","expectedOutput":"{\"a.0\":1,\"a.1\":2,\"a.2\":3}"},{"input":"{\"a\":{\"b\":{\"c\":\"deep\"}},\"d\":4}","expectedOutput":"{\"a.b.c\":\"deep\",\"d\":4}"},{"input":"{\"users\":[{\"name\":\"Alice\"},{\"name\":\"Bob\"}]}","expectedOutput":"{\"users.0.name\":\"Alice\",\"users.1.name\":\"Bob\"}"}]', NULL, 5000, 256, NULL, 1500, 1200, 'model_selection', 'Choosing mid-tier models for moderate complexity', NULL, 0, NULL, 'core', 0);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('recursive-tree-traversal', 'Recursive Tree Traversal', 'Implement DFS (depth-first search) and BFS (breadth-first search) on a tree.
...
module.exports = { evaluate };', '[{"input":"let x = 10\nlet y = 3\nx * y + 2","expectedOutput":"32"},{"input":"let a = (2 + 3) * 4\na / 2","expectedOutput":"10"},{"input":"5 + 3 * 2","expectedOutput":"11"},{"input":"let x = 7\nlet y = x + 3\ny * 2","expectedOutput":"20"},{"input":"(1 + 2) * (3 + 4)","expectedOutput":"21"},{"input":"let a = 10\nlet b = 3\na / b","expectedOutput":"3"}]', NULL, 5000, 256, NULL, 15000, 2400, 'model_selection', 'Allocating budget to genuinely hard problems', NULL, 0, NULL, 'headline', 1);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('cost-optimizer', 'Cost Optimizer', 'Build a module with 3 simple utility functions:
...
module.exports = { isPalindrome, capitalize, sum };', '[{"input":"isPalindrome\nA man, a plan, a canal: Panama","expectedOutput":"true"},{"input":"isPalindrome\nhello world","expectedOutput":"false"},{"input":"capitalize\nhello world foo bar","expectedOutput":"Hello World Foo Bar"},{"input":"sum\n[1,2,3,4,5]","expectedOutput":"15"},{"input":"isPalindrome\nracecar","expectedOutput":"true"}]', NULL, 5000, 256, NULL, NULL, 1800, 'model_selection', 'Strategic model switching for mixed-difficulty tasks', NULL, 0, NULL, 'headline', 7);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('array-flatten', 'Array Flatten', 'Write a function that deeply flattens a nested array of any depth.
...
module.exports = { flatten };', '[{"input":"[1,[2,[3,[4]]]]","expectedOutput":"[1,2,3,4]"},{"input":"[[1,2],[3,[4,5]]]","expectedOutput":"[1,2,3,4,5]"},{"input":"[]","expectedOutput":"[]"},{"input":"[1,2,3]","expectedOutput":"[1,2,3]"},{"input":"[[[1]],[[2]],[[3]]]","expectedOutput":"[1,2,3]"}]', NULL, 5000, 256, NULL, NULL, 900, 'prompt_efficiency', 'Minimal prompting for simple tasks', NULL, 0, NULL, 'core', 0);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('debounce-throttle', 'Debounce & Throttle', 'Implement debounce and throttle functions.
...
Moderate AI budget ($0.015) — describe both functions clearly and concisely in a single prompt exchange.', 'easy', 'function debounce(fn, ms) {
  // Your code here
}
...
module.exports = { solve };', 0, NULL, 'core', 24);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('deep-clone', 'Deep Clone', 'Write a function that creates a deep clone of an object.
...
module.exports = { deepClone };', '[{"input":"{\"a\":1,\"b\":{\"c\":2}}","expectedOutput":"{\"a\":1,\"b\":{\"c\":2}}"},{"input":"{\"arr\":[1,[2,3],{\"x\":4}]}","expectedOutput":"{\"arr\":[1,[2,3],{\"x\":4}]}"},{"input":"null","expectedOutput":"null"},{"input":"{\"a\":{\"b\":{\"c\":{\"d\":\"deep\"}}}}","expectedOutput":"{\"a\":{\"b\":{\"c\":{\"d\":\"deep\"}}}}"},{"input":"[1,2,3]","expectedOutput":"[1,2,3]"}]', NULL, 5000, 256, NULL, NULL, 900, 'prompt_efficiency', 'Minimal prompting for utility functions', NULL, 0, NULL, 'core', 0);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('promise-pool', 'Promise Pool', 'Implement a promise pool with a concurrency limit.
...
module.exports = { promisePool };', '[{"input":"basic\n3\n2","expectedOutput":"[1,2,3]"},{"input":"single-concurrency\n3\n1","expectedOutput":"[1,2,3]"},{"input":"all-concurrent\n3\n3","expectedOutput":"[1,2,3]"},{"input":"empty\n0\n2","expectedOutput":"[]"}]', NULL, 5000, 256, NULL, NULL, 1200, 'prompt_efficiency', 'Precise specification of async concurrency', NULL, 0, NULL, 'core', 0);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('template-engine', 'Template Engine', 'Build a simple Mustache-style template engine.
...
module.exports = { render };', '[{"input":"Hello {{name}}!\n{\"name\":\"World\"}","expectedOutput":"Hello World!"},{"input":"{{#if show}}visible{{/if}}\n{\"show\":true}","expectedOutput":"visible"},{"input":"{{#if show}}visible{{/if}}\n{\"show\":false}","expectedOutput":""},{"input":"{{#each items}}{{.}} {{/each}}\n{\"items\":[\"a\",\"b\",\"c\"]}","expectedOutput":"a b c "},{"input":"{{user.name}} is {{user.age}}\n{\"user\":{\"name\":\"Alice\",\"age\":30}}","expectedOutput":"Alice is 30"}]', NULL, 5000, 256, NULL, NULL, 1500, 'prompt_efficiency', 'Structured prompting for template syntax', NULL, 0, NULL, 'core', 0);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('linked-list-operations', 'Linked List Operations', 'Implement four linked list operations. Lists use the shape { val: any, next: Node | null }.
...
module.exports = { fromArray, toArray, reverse, merge };', '[{"input":"toArray\n[1,2,3]","expectedOutput":"[1,2,3]"},{"input":"reverse\n[1,2,3]","expectedOutput":"[3,2,1]"},{"input":"merge\n[1,3,5]\n[2,4,6]","expectedOutput":"[1,2,3,4,5,6]"},{"input":"reverse\n[]","expectedOutput":"[]"},{"input":"merge\n[1,2]\n[]","expectedOutput":"[1,2]"},{"input":"toArray\n[42]","expectedOutput":"[42]"}]', NULL, 5000, 256, NULL, NULL, 1200, 'prompt_efficiency', 'Concise specification of multiple related functions', NULL, 0, NULL, 'core', 0);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('schema-validator', 'Schema Validator', 'Write a function that validates an object against a schema definition.
...
module.exports = { solve };', 0, NULL, 'onboarding', 5);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('buggy-promise-chain', 'Buggy Promise Chain', 'This async waterfall function is supposed to run an array of async functions in sequence, passing each result to the next. It has 3 bugs:
...
module.exports = { solve };', 0, NULL, 'core', 0);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('leaky-rate-limiter', 'Leaky Rate Limiter', 'This token bucket rate limiter has 3 bugs:
...
module.exports = { solve };', 0, NULL, 'core', 0);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('broken-iterator', 'Broken Iterator', 'This custom range iterator has 3 bugs:
...
module.exports = { range };', '[{"input":"1 5","expectedOutput":"[1,2,3,4,5]"},{"input":"0 10 3","expectedOutput":"[0,3,6,9]"},{"input":"5 1","expectedOutput":"[5,4,3,2,1]"},{"input":"10 0 -2","expectedOutput":"[10,8,6,4,2,0]"},{"input":"3 3","expectedOutput":"[3]"}]', NULL, 5000, 256, NULL, 500, 900, 'iterative_debugging', 'Fixing iteration logic bugs', 'function solve(...args) {
...
module.exports = { solve };', 0, NULL, 'onboarding', 4);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('flaky-queue', 'Flaky Queue', 'This priority queue (min-heap) has 3 bugs:
...
module.exports = { solve };', 0, NULL, 'core', 0);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('corrupted-trie', 'Corrupted Trie', 'This Trie implementation has 3 bugs:
...
module.exports = { solve };', 0, NULL, 'core', 0);
INSERT OR REPLACE INTO challenges (id, title, description, difficulty, starter_code, test_cases, hidden_test_cases, exec_time_limit, exec_memory_limit, max_tokens, max_cost, wall_clock_limit, category, skill_tested, test_harness, use_stdin, tags, tier, sort_order) VALUES ('broken-differ', 'Broken Differ', 'This object diff function returns the differences between two objects but has 3 bugs:
