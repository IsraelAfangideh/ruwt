...
import { PassThresholdEditor, type PassThreshold } from '@/features/assessments/components/PassThresholdEditor';
import { useColors } from '@/shared/theme';
import { spacing, fontSizes, fontFamily } from '@/shared/theme/tokens';
import type { Weights } from '@/features/assessments/hooks/useAssessmentIDEState';
                ...
                {companyLogoUrl && /^https?:\/\//i.test(companyLogoUrl) && (
                  <View style={{ marginTop: spacing.sm, flexDirection: 'row', alignItems: 'center', gap: spacing.sm }}>
                    <img
                      ...
                      onError={/* istanbul ignore next -- @preserve */ (e) => { (e.target as HTMLImageElement).style.display = 'none'; }}
                    />
