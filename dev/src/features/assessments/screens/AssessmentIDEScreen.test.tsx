...
vi.mock('@/features/assessments/hooks/useAssessmentIDEState', () => ({
...
vi.mock('@/features/shared-ide/components/PanelResizeBar', () => ({
...
vi.mock('@/features/assessments/components/AssessmentIDEHeader', () => ({
...
vi.mock('@/features/assessments/components/AssessmentActionBar', () => ({
...
vi.mock('@/features/assessments/components/AssessmentChatPanel', () => ({
  AssessmentChatPanel: () => <div data-testid="chat-panel">Chat Panel</div>,
}));
vi.mock('@/features/assessments/components/AssessmentDocumentPanel', () => ({
