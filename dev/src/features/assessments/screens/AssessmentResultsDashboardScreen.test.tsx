...
vi.mock('@/features/assessments/components/CandidateInsightsPanel', () => ({
  CandidateInsightsPanel: () => <div data-testid="insights-panel" />,
}));
vi.mock('@/features/assessments/components/CandidateComparisonView', () => ({
  CandidateComparisonView: () => <div data-testid="comparison-view" />,
}));
vi.mock('@/features/assessments/components/VerdictBadge', () => ({
  VerdictBadge: () => <span data-testid="verdict-badge" />,
  computeVerdict: () => 'pass',
}));
vi.mock('@/features/assessments/components/InviteManagementTable', () => ({
