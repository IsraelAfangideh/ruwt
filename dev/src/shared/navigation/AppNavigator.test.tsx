...
vi.mock('@/features/assessments/AssessmentListScreen', () => ({ AssessmentListScreen: () => <div>AssessmentListScreen</div> }));
vi.mock('@/features/assessments/AssessmentIDEScreen', () => ({ AssessmentIDEScreen: () => <div>AssessmentIDEScreen</div> }));
vi.mock('@/features/assessments/AssessmentResultsDashboardScreen', () => ({ AssessmentResultsDashboardScreen: () => <div>AssessmentResultsDashboardScreen</div> }));
vi.mock('@/features/assessments/AssessmentLandingScreen', () => ({ AssessmentLandingScreen: () => <div>AssessmentLandingScreen</div> }));
vi.mock('@/features/assessments/AssessmentFlowScreen', () => ({ AssessmentFlowScreen: () => <div>AssessmentFlowScreen</div> }));
vi.mock('@/features/assessments/AssessmentResultsScreen', () => ({ AssessmentResultsScreen: () => <div>AssessmentResultsScreen</div> }));
