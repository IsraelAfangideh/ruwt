...
export const arena = {
  ...
  borderMuted: 'rgba(240,246,252,0.06)',
  borderFaint: 'rgba(240,246,252,0.03)',
  text: '#e6edf3',
  textMuted: '#8b929a',
  textSubtle: '#929aaa',
  accent: '#c9a962',
  accentBg: 'rgba(201,169,98,0.12)',
  accentBgSubtle: 'rgba(201,169,98,0.08)',
  accentBgFaint: 'rgba(201,169,98,0.04)',
  accentBorder: 'rgba(201,169,98,0.2)',
  accentBorderSubtle: 'rgba(201,169,98,0.15)',
  success: '#3fb950',
  error: '#f85149',
};
